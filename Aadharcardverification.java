...
import javax.swing.*;
public class Aadharcardverification{
    public static void main(String args[]){
        new Aadharcardverification();
    }
    private JFrame frame;
    private JTextField numberField;
    private JLabel validLabel;
    private JButton verifyButton;
    public Aadharcardverification(){
      ...
      //pattern class containes matcher() method
      //to find matching between given string string
